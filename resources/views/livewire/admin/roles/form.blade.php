<div>
    ...
    <div class="page-header"><div><p class="eyebrow">{{ __('Access control') }}</p><h1>{{ $roleKey ? __('Edit role') : __('Create custom role') }}</h1><p class="muted">{{ $custom ? __('Choose the abilities this role grants.') : __('Only assignment availability can change for a system role.') }}</p></div></div>
