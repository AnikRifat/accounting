...
{{-- Off-canvas side panel. Bind its open state with wire:model (or x-model); focus moves to the first [autofocus] field. With `submit`, the body and footer form one Livewire form. --}}
